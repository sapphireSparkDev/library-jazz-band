      ...
      <div className="flex flex-col items-center w-screen background">
        ...
        <div className="w-3/6 justify-items-center">
          ...
          <p className="text-center text-lg mb-14 font-roboto lg:w-fit w-fit">
            ...
            seasoned professionals and passionate, experienced amateurs is
            united by a shared love for the big band format and our commitment
            to bringing vibrant, live jazz music to the community.
          </p>
        </div>
